    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // WebSocket upgrade for WebRTC signaling (JWT validated in handshake interceptor)
                ...
                // Internal endpoint for other microservices (e.g. service-test OpenFeign for freelancer names)
                ...
                // AI freelancer suggestion (authenticated)
                .requestMatchers("/api/users/ai/**").authenticated()
                ...
                .requestMatchers("/api/posts/**").authenticated() // Feed / posts (TikTok-style)
