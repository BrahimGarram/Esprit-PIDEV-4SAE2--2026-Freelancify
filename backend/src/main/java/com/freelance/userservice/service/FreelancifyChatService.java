...
public class FreelancifyChatService {
    ...
    private static final String SYSTEM_PROMPT = """
        ...
        Your role: answer questions about how to use Freelancify, give tips for clients and freelancers, explain workflows (posting a project, sending a proposal, using the project room), and be helpful and concise. \
